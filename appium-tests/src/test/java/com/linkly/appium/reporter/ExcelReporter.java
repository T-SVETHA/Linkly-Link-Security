...
public class ExcelReporter {
    ...
    public static void main(String[] args) {
        try {
            ...
            File projectRoot = currentDir.getName().equals("appium-tests") ? currentDir.getParentFile() : currentDir;
            File testResultsDir = new File(projectRoot, "appium-tests/build/test-results/test");
            File reportsDir = new File(projectRoot, "appium-tests/reports");
