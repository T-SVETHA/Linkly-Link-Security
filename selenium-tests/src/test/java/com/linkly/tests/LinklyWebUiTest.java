...
public class LinklyWebUiTest {
    ...
    public void setUp() {
        ...
        // Check system property or environment variable to toggle headless mode
        String headlessProp = System.getProperty("headless");
        String headlessEnv = System.getenv("HEADLESS");
        boolean headless = true;
        if ("false".equalsIgnoreCase(headlessProp) || "false".equalsIgnoreCase(headlessEnv)) {
            headless = false;
        }
    ...
    public void TC_PAR_11_RealTimeGpsCard_shouldDisplayMapFrame() {
        ...
        WebElement miniMap = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("miniMap")));
