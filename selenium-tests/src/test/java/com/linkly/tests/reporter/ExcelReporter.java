...
public class ExcelReporter {
    ...
    public static void main(String[] args) {
        try {
            ...
            File projectRoot = currentDir.getName().equals("selenium-tests") ? currentDir.getParentFile() : currentDir;
            File testResultsDir = new File(projectRoot, "selenium-tests/build/test-results/test");
            File reportsDir = new File(projectRoot, "selenium-tests/reports");
